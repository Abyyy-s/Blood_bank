...
(function () {
    ...
    function installMobileNavigation() {
        if (document.querySelector('.ll-menu-toggle')) return;
        ...
        const close = () => {
            sidebar.classList.remove('ll-open');
            document.body.classList.remove('ll-sidebar-open');
            button.setAttribute('aria-expanded', 'false');
            button.innerHTML = '<i class="fas fa-bars" aria-hidden="true"></i>';
        };
        const open = () => {
            sidebar.classList.add('ll-open');
            document.body.classList.add('ll-sidebar-open');
            button.setAttribute('aria-expanded', 'true');
            button.innerHTML = '<i class="fas fa-xmark" aria-hidden="true"></i>';
        };
        button.addEventListener('click', () => sidebar.classList.contains('ll-open') ? close() : open());
